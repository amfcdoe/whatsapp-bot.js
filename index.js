...
const start = async (client = new Client()) => {
        ...
        client.onAddedToGroup(((chat) => {
            ...
            if (totalMem < 25) { 
            	client.sendText(chat.id, `cih member nya cuma ${totalMem}, Kalo mau invite bot, minimal jumlah memner ada 25`).then(() => client.leaveGroup(chat.id)).then(() => client.deleteChat(chat.id))
            } else {
