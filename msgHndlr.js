...
module.exports = msgHandler = async (client, message) => {
    try {
        ...
        const mess = {
            wait: 'Permintaan Sedang Di Proses...',
            error: {
        ...
        const apiKey = '8sh8RRJal0TD48imRUsG' // apikey you can get it at https://mhankbarbar.herokuapp.com/api
	    ...
	    if (isMedia) {
                try {
                    ...
                    var result = await removeBackgroundFromImageBase64({ base64img, apiKey: '8sh8RRJal0TD48imRUsG', size: 'auto', type: 'auto', outFile })
        ...
        case '!nulis':
            ...
            .then(res => res.json())
            .then(async (json) => {
                await client.sendFileFromUrl(from, json.result, 'Nulis.jpg', 'DONE', id)
        ...
        case '!fb':
            ...
            client.reply(from, mess.wait, id)
            const epbe = await get.get(`https://mhankbarbar.herokuapp.com/api/epbe?url=https://www.facebook.com/24609282673/posts/10158628585367674/&apiKey=8sh8RRJal0TD48imRUsG`).json()
        ...
        case '!ig':
            ...
            try {
                client.reply(from, mess.wait, id)
                const resp = await get.get(`https://mhankbarbar.herokuapp.com/api/ig?url=https://www.instagram.com/p/CFoVkHlFP3n/?igshid=sz6giw37qp9f&apiKey=8sh8RRJal0TD48imRUsG`).json()
        ...
        case '!wait':
            ...
            break
		case '!sendto':
            client.sendFile(from, './test.png', 'test.png', 'TEST')
            break
        case '!quotemaker':
            arg = body.trim().split('|')
            if (arg.length >= 4) {
        ...
        case '!demote':
            ...
            await client.sendTextWithMentions(from, `Perintah diterima, Menghapus Admin @${mentionedJidList[0]}.`)
            break
        case '!join':
        ...
        case '!jadwaltvnow':
            ...
            break
		case '!bucin':
			const bucin = await get.get('https://clientz.herokuapp.com/api/howbucins').json()
			client.reply(from, `Text : ${desc}\n\nPersen ${persen}`)
			break
        case '!loli':
        ...
        case '!url2img':
            ...
            const url2img = await get.get(`https://mhankbarbar.herokuapp.com/api/url2image?url=https://mhankbarbar.herokuapp.com/api&apiKey=8sh8RRJal0TD48imRUsG`).json()
        ...
        case '!menu':
            ...
            break
		case '!sewa':
            client.sendText(from, '*Jasa Sewa AMF BOT*\n*1 Minggu : 15.000*\n*1 Bulan : 35.000*')
            break
        case '!readme':
            client.reply(from, readme, id)
            break
        case '!info':
            client.sendLinkWithAutoPreview(from, '', info)
            break
        case '!snk':
